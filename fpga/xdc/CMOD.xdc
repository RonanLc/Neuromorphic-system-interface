...
# set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { bt_LRUDC[1] }]; #IO_L19P_T3_16 Sch=btn[1]


## Pmod Header JA
# set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports {cs }]; #IO_L5N_T0_D07_14 Sch=ja[1]
...
# set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { APtime[0] }]; #IO_L5P_T0_D06_14 Sch=ja[7]
# set_property -dict { PACKAGE_PIN H19   IOSTANDARD LVCMOS33 } [get_ports { APtime[1] }]; #IO_L4P_T0_D04_14 Sch=ja[8]
# set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS33 } [get_ports { APtime_long[0] }]; #IO_L6N_T0_D08_VREF_14 Sch=ja[9]
# set_property -dict { PACKAGE_PIN K18 IOSTANDARD LVCMOS33 } [get_ports {  APtime_long[1] }]; #IO_L8N_T1_D12_14 Sch=ja[10]
...
#set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { oscilloscope[3] }]; #IO_L5P_T0_AD13P_35 Sch=pio[12]
#set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports { oscilloscope[4] }]; #IO_L6N_T0_VREF_35 Sch=pio[13]
#set_property -dict { PACKAGE_PIN L2    IOSTANDARD LVCMOS33 } [get_ports { oscilloscope[5] }]; #IO_L5N_T0_AD13N_35 Sch=pio[14]
